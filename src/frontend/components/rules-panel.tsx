...
export function RulesPanel({ api, categories, category, onSelectCategory, onToast }: Props) {
  ...
  async function createCategory() {
    ...
    await api.createCategory({ name: newName, icon: newIcon, description: newDescription, sourceUrls, geositeNames, geoipNames, syncIntervalMinutes: newSyncInterval, tokenLinksEnabled: createMode === 'manual', publicLinksEnabled: createMode === 'upstream' });
